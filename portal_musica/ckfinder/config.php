...
function CheckAuthentication()
{
	...
	//Tem que arrumar isso aqui depois.
	//Fazer uma validação para não deixar isso true
	//Deixando assim qualquer pessoa pode ter acesso as imagens do site, e isso é muito inseguro
	return true;
}
...
*/
$baseUrl = '/portal_musica/ckfinder/userfiles/';
